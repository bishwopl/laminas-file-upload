...
namespace LaminasFileUpload\Service;

use Laminas\Session\Container;
use Laminas\InputFilter;
use LaminasFileUpload\Form\BaseUploadForm;
use LaminasFileUpload\ModuleOptions\ModuleOptions;

class FileUploadService {

    /**
     * @var \LaminasFileUpload\ModuleOptions\ModuleOptions
     */
    protected $moduleOptions;

    /**
     * @var \LaminasFileUpload\Storage\StorageInterface 
     */
    ...
    /**
     * 
     * @return \LaminasFileUpload\Entity\FileEntityInterface
     */
    ...
    public function cropImage($cropDim, $files) {
        ...
        foreach ($files as $f) {
            ...
            $thumb = new \LaminasFileUpload\MyThumb($f);
